...
class ModelWebVideoCategory extends Model {
    ...
    public function getCategory($category_id) {
		...
		$query = $this->db->query("SELECT DISTINCT i.*, id.* FROM " . DB_PREFIX . "video_category i LEFT JOIN " . DB_PREFIX . "video_category_description id ON (i.video_category_id = id.video_category_id) WHERE id.video_category_id = '" . (int)$category_id . "'");
