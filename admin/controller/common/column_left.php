...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'web/information')) {		
				$web[] = array(
					'name'	   => $this->language->get('text_web_information'),
					'href'     => $this->url->link('web/information', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
			}
			...
			if ($this->user->hasPermission('access', 'web/blog')) {		
				$web[] = array(
					'name'	   => $this->language->get('text_web_blog'),
					'href'     => $this->url->link('web/blog', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
			}
			...
			if ($this->user->hasPermission('access', 'web/video')) {		
				$web[] = array(
					...
					'href'     => $this->url->link('web/video', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
			}
            ...
            if ($this->user->hasPermission('access', 'web/newsletter')) {
                $web[] = array(
                    'name'	   => $this->language->get('text_web_newsletter'),
                    'href'     => $this->url->link('web/newsletter', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'web/prize')) {
                $web[] = array(
                    'name'	   => $this->language->get('text_web_prize'),
                    'href'     => $this->url->link('web/prize', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'web/landing')) {
                $web[] = array(
                    'name'	   => $this->language->get('text_web_landing'),
                    'href'     => $this->url->link('web/landing', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
			...
			if ($web) {
				$data['menus'][] = array(
					'id'       => 'menu-web-util',
					'icon'	   => 'fa-tags', 
					'name'	   => $this->language->get('text_web_util'),
					'href'     => '',
					'children' => $web
				);		
			}
