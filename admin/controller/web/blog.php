...
class ControllerWebBlog extends Controller {
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('web/blog', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);

		$data['add'] = $this->url->link('web/blog/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('web/blog/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$blog_total = $this->model_web_blog->getTotalBlogs();
		...
		$pagination->url = $this->url->link('web/blog', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('web/blog_list', $data));
	}
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_web_blog->addBlog($this->request->post);
			...
			$this->response->redirect($this->url->link('web/blog', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_web_blog->editBlog($this->request->get['blog_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			foreach ($this->request->post['selected'] as $blog_id) {
				...
				$this->model_web_blog->deleteBlog($blog_id);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['blog_id'])) {
			$data['action'] = $this->url->link('web/blog/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('web/blog/edit', 'user_token=' . $this->session->data['user_token'] . '&blog_id=' . $this->request->get['blog_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('web/blog', 'user_token=' . $this->session->data['user_token'] . $url, true);

		if (isset($this->request->get['blog_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$blog_info = $this->model_web_blog->getBlog($this->request->get['blog_id']);
		}
		...
		if (isset($this->request->post['blog_description'])) {
			...
			$data['blog_description'] = $this->model_web_blog->getBlogDescriptions($this->request->get['blog_id']);
		} else {
		...
		if (isset($this->request->post['blog_store'])) {
			...
			$data['blog_store'] = $this->model_web_blog->getBlogStores($this->request->get['blog_id']);
		} else {
		...
		if (isset($this->request->post['blog_seo_url'])) {
			...
			$data['blog_seo_url'] = $this->model_web_blog->getBlogSeoUrls($this->request->get['blog_id']);
		} else {
		...
		if (isset($this->request->post['blog_layout'])) {
			...
			$data['blog_layout'] = $this->model_web_blog->getBlogLayouts($this->request->get['blog_id']);
		} else {
		...
		$this->response->setOutput($this->load->view('web/blog_form', $data));
	}


	protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'web/blog')) {
